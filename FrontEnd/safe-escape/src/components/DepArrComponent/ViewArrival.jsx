...
const ViewReturn = (props) => {
  ...
  return (
    <div>
      ...
      {/* <Button variant="contained" style={{ position: 'center', right: -90, top: -40, backgroundColor: 'white', color: "#f99965" }} className="float-right" onClick={() => history.push('/ArrivalFlightDetails')} type="primary">Previous</Button> */}
