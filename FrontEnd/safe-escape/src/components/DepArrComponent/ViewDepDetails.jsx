...
export default function ViewDepDetails() {
    ...
    return (
        <div>
            <Button variant="contained" style={{ position: 'center', right: -90, top: 150, backgroundColor: 'white', color: "#f99965" }} className="float-right" onClick={() => history.push('./ViewOutBoundFlight')} type="primary">Previous</Button>
