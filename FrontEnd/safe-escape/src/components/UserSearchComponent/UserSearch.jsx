...
const UserSearch = (props) => {
  ...
  return (
    ...
    <div style={{ alignItems: 'center' }}>
      <div style={{ backgroundImage: "url(/airplane-sky-flight-clouds.jpg)", backgroundSize: '100%', height: '100vh', zIndex: '0', backgroundRepeat: "no-repeat" }} className="d-flex flex-column justify-content-center align-items-center" >
